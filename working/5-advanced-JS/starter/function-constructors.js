var Cat = function(name, breed, color, yearOfBirth) {  // Create main object.
  this.name = name;
  this.breed = breed;
  this.color = color;
...
var sweetness = new Cat('Sweetness', 'Forest', 'Black', 2011);    // These are instances of the cat object.
